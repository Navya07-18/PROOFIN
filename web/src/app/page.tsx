...
export default function HomePage() {
  ...
  const categories = ["All", "Workshops", "Hackathons", "Masterclass", "Networking"];
  ...
  return (
    <div className="space-y-16 pb-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-6">
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-indigo-50/90 border border-indigo-200/80 text-indigo-700 text-xs font-semibold backdrop-blur-md shadow-sm">
              ...
              <span>Supersonic Commitments on Monad Testnet</span>
            </div>
            ...
            <p className="text-xs sm:text-sm text-charcoal-500 max-w-lg leading-relaxed">
              No more empty seats or broken bookings. PROOFIN transforms reservations from
              passive database rows into <strong>programmable smart contract commitments</strong> with
              automatic on-chain deposit settlement.
            </p>
            ...
            <div className="pt-6 border-t border-charcoal-200/50 grid grid-cols-3 gap-4 max-w-md">
              <div>
                ...
                <span className="text-[11px] text-charcoal-500 font-medium">TPS on Monad</span>
              </div>
              <div>
                <span className="block text-xl font-bold text-emerald-600">100%</span>
                <span className="text-[11px] text-charcoal-500 font-medium">Refundable</span>
              </div>
              <div>
          ...
          {/* Right Column: Featured Demo Event Card */}
                ...
                <GlassCard variant="elevated" className="overflow-hidden border-indigo-200/60 p-6 space-y-5">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center gap-2 text-xs text-emerald-700 font-medium">
                      ...
                      <span>🟢 Refundable when you check in.</span>
                    </div>
      ...
      {/* 2. HOW PROOFIN WORKS (3-STEP PIPELINE) */}
      <section className="px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="text-center space-y-2 mb-10">
          ...
          <p className="text-xs sm:text-sm text-charcoal-500 max-w-md mx-auto">
            From commitment to automatic settlement on Monad in three clean steps.
          </p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {/* Step 1 */}
          <GlassCard className="p-6 space-y-4 border-charcoal-200/50 hover:border-indigo-300/80">
            ...
            <p className="text-xs text-charcoal-600 leading-relaxed">
              Lock a small commitment deposit (e.g. 0.01 MON) into the smart contract.
              You receive a digital ticket pass on Monad.
            </p>
            <div className="text-[11px] font-mono text-charcoal-400 bg-charcoal-50 p-2.5 rounded-lg border border-charcoal-100">
              State: 🟡 <strong>RESERVED</strong>
            </div>
          </GlassCard>

          {/* Step 2 */}
          <GlassCard className="p-6 space-y-4 border-charcoal-200/50 hover:border-indigo-300/80">
            <div className="w-12 h-12 rounded-2xl bg-purple-50 border border-purple-100 flex items-center justify-center text-purple-600 font-black text-lg shadow-sm">
              02
            </div>
            <h3 className="text-lg font-bold text-charcoal-900 flex items-center gap-2">
            ...
            <p className="text-xs text-charcoal-600 leading-relaxed">
              Arrive at the event before the check-in deadline. Check in via QR code or
              direct on-chain transaction from your connected wallet.
            </p>
            <div className="text-[11px] font-mono text-purple-700 bg-purple-50 p-2.5 rounded-lg border border-purple-100">
              State: 🔵 <strong>CHECKED IN</strong>
            </div>
          </GlassCard>
          ...
          <GlassCard className="p-6 space-y-4 border-charcoal-200/50 hover:border-indigo-300/80">
            ...
            <p className="text-xs text-charcoal-600 leading-relaxed">
              The smart contract verifies your attendance and automatically releases 100% of
              your commitment deposit back to your wallet.
            </p>
            <div className="text-[11px] font-mono text-emerald-700 bg-emerald-50 p-2.5 rounded-lg border border-emerald-100">
              State: 🟢 <strong>DEPOSIT RELEASED</strong>
            </div>
          </GlassCard>
        </div>
      </section>

      {/* 3. EVENT DISCOVERY SECTION */}
      <section id="events" className="px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto space-y-8">
